        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="container" class="mt-5">
                    <h5 class="text-center">Ingresa los siguientes datos para realizar el registro</h5>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nombreUsu" class="col-md-4 col-form-label text-md-end">{{ __('Nombre Completo') }}</label>
